...
data = data[['Year','timestamp','PrimClass_Jaylin']]
# Renaming columns
data.columns = ['Year','timestamp','Energy consumption']

# Cleaning Weather data.
df = pd.read_csv('E:\Thesis\dataset\Working Directory\w3.csv')
df = df.iloc[0:8016,0:18]
...
data['Conditions'].replace('Ice Pellets','Snow',inplace=True)
